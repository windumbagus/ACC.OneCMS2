						...
						<div class="row">
							<form id="form-seamless-unit-picture" action="{{ asset('/seamless-unit-picture/uploadpicture') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
									...
									<div class="form-group" style="display:none;">
										...
										<div class="col-sm-7">
											<input type="text" class="form-control" name="PATH_FILE" id="PATH_FILE" value="{{$SeamlessUnitPictures->PATH_FILE}}" readonly>
										</div>
									</div>
									<br/>
									<div class="form-group">
										...
										<div class="col-sm-7">
											<img style="width: 50%; height: 50%;" src="{{$SeamlessUnitPictures->URL}}" alt=""
