...
<div class="box box-primary">
    <div class="box-header with-border">
        <h4 class="box-title">Upload OTR</h4> 
    </div>
    <div class="box-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <button type="button" class="btn btn-primary" onclick="location.href='{{asset('/seamless-otrupload/download')}}';">Download Template</button>	
                    </div>
