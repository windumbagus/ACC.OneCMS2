...
<div class="box box-primary">
    ...
    <div class="box-body">
        <form id="form-upload-seamless-unit-detail" action="{{asset('/seamless-unit-detail/upload/'.$unitid)}}" method="post" enctype="multipart/form-data"> 
            @csrf
               
            Structure : CATEGORY, CD_VALUE, CHAR_VALUE, CHAR_DESC, ID_USER_ADDED, ID_USER_UPDATED<br>
            <br/><br/>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <button type="button" class="btn btn-primary" onclick="location.href='{{asset('/seamless-unit-detail/upload-pages/download')}}';">Download Template</button>	
                    </div>
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="col-sm-6">
                    <a href="{{asset('/seamless-unit-detail/cancel/'.$unitid)}}" class="btn btn-block btn-primary">Back</a>
                </div>
                <div class="col-sm-6">
