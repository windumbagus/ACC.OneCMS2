...
<head>
  ...
  <link rel="shortcut icon" href="assets/ACC_logo.ico"> 
  <title>CMS-LMS ACC | Login</title>
...
<div class="login-box">
  ...
  <!-- /.login-box-body -->
  <p style="margin-top:10%" class="login-box-msg"><strong>Copyright &copy; 2019 <a href="#">WMB & ISRD</a>.</strong>  All rights reserved.</p>
</div>
<!-- /.login-box -->
