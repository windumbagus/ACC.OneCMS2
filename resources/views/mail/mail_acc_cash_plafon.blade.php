    ...
    <div class="panel-header" style="height:115px; background:#081e33;">
      <br><img src="{{ asset('assets/Pictures/logo_acccash_text.png') }}" style="width:300px; height:75px !important; ;" alt="logoacccash" class="center"><br><br>
        ...
        <div class="panel-body">
            ...
            <img src="{{ asset('assets/Pictures/Ilustrasi_acccash-02.jpg') }}" class="center" style="height:300px;" alt="ilustrasi"><br><br>
            <p>Selamat!</p>
    ...
    <div  style=" width:800px; border-radius: 25px; border:1px solid;  border-spacing: 0px; color: #081e33; margin: 0 auto;">
        ...
        <div style="margin:20px">
            ...
            <div style="text-align:center;"> 
                <img src="{{ asset('assets/Pictures/Ilustrasi_acccash-02.jpg') }}" style="height:300px; " alt="ilustrasi"><br><br>
            </div>
            <p>Selamat!</p>
            <p>Kamu mendapatkan plafon sebesar {{$data_mail["PLAFOND"]}} yang dapat kamu cairkan melalui
                aplikasi acc.one.<br>
