...
<body>
    <div class="center panel panel-default" style=" width:800px; border-radius: 25px; border: 2px solid">
        ...
        <div class="panel-body">
          ...
          <a class="center" href="https://www.acc.co.id/acccash"><img src="{{ asset('assets/Pictures/Picture2.png') }}" style="width:250px; height:50px !important; display: block; margin-left: auto; margin-right: auto;" alt="" class="center"></a>    
          <div class="tengah">
